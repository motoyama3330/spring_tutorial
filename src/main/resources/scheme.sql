...
ALTER TABLE reservation DROP CONSTRAINT IF EXISTS FK_resqnfjcp370rygd9hjjxjtg;
...
ALTER TABLE reservation ADD CONSTRAINT FK_resqnfjcp370rygd9hjjxjtg FOREIGN KEY (user_id) REFERENCES usr;
